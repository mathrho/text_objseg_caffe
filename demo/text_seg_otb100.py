...
for videofile in videofiles:
    ...
    for fi in range(start_frame_id, 1+start_frame_id):
        ...
        # save the results
        if not os.path.exists('../results/OTB100/results_lang_seg_sigmoid_thresh0.6/'+video):
            os.makedirs('../results/OTB100/results_lang_seg_sigmoid_thresh0.6/'+video)
        if video == 'Board':
            filename = '../results/OTB100/results_lang_seg_sigmoid_thresh0.6/'+video+'/%05d.jpg' % (fi,)
        else:
            filename = '../results/OTB100/results_lang_seg_sigmoid_thresh0.6/'+video+'/%04d.jpg' % (fi,)
