...
for v, videofile in enumerate(videofiles):
    ...
    for q in range(num_queries):
        ...
        for fi in range(start_frame_id, num_frames+start_frame_id):
            ...
            score_thresh = np.amax(upscores) * 0.3
            ...
            if not os.path.exists('../results/ILSVRC/results_lang_seg_sigmoid_thresh0.3/'+video_prefix):
                os.makedirs('../results/ILSVRC/results_lang_seg_sigmoid_thresh0.3/'+video_prefix)
            filename = '../results/ILSVRC/results_lang_seg_sigmoid_thresh0.3/'+video_prefix+'/%06d.jpg' % (fi,)
